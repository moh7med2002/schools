...
export default function RegisterStudent() {
    ...
    const registerStudent = async (data) => {
        ...
        const res = await fetch(`${process.env.REACT_APP_API}api/student/auth/register`,{
            method : "POST",
            body : formData
        });
        ...
        const {isLoading , mutate: registerMutate } = useMutation(registerStudent ,{
            onError:()=>{

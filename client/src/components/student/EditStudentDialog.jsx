...
export default function EditStudentProfile({setOpenDialog}) {
    ...
    const onSubmit = async (data) => {
        ...
        try{
            const res = await fetch(`${process.env.REACT_APP_API}api/student/update/information`,{
                method:"PUT",
                headers:{
                    "Authorization":token
                },
            ...
            if(res.status!==200 && res.status!==201){
                throw new Error('update student information failed');
            }
